...
"}")
        ...
        self.btn_mentor_meeting_identified.setStyleSheet("QPushButton {\n"
"    background-color: #D96B6B;\n"
"    color: white;\n"
"    border-radius: 8px;\n"
"border: 2px solid #B85A5A; \n"
...
"}")
        ...
        self.btn_mento_meting_not_identified.setStyleSheet("QPushButton {\n"
"    background-color: #D96B6B;\n"
"    color: white;\n"
"    border-radius: 8px;\n"
"border: 2px solid #B85A5A; \n"
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.line_search.setText(_translate("MainWindow", "Search by name or surname..."))
        self.btn_return_preferences_menu.setText(_translate("MainWindow", "<- RETURN PREFERENCES MENU"))
        self.comboBox.setItemText(0, _translate("MainWindow", "Applications Duplicate Record"))
        self.comboBox.setItemText(1, _translate("MainWindow", "Previous VIT Check"))
        self.comboBox.setItemText(2, _translate("MainWindow", "Different Records"))
        self.comboBox.setItemText(3, _translate("MainWindow", "Application Filter"))
